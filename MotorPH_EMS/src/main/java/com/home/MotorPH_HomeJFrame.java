...
private boolean isCheckedIn = false;
    ...
    if (isCheckedIn) {
        ...
        boolean alreadyCheckedIn = MotorPH_DBAtt.hasCheckedIn(value, parsedDate, Time.valueOf(timeString)); // Converted to Time data type
        if (alreadyCheckedIn) {
            JOptionPane.showMessageDialog(null, "You are already logged in for today.");
...
private boolean isCheckedOut = false;
    ...
    if (isCheckedOut) {
        ...
        // Check if the user has already checked in for the current date
        boolean alreadyCheckedIn = MotorPH_DBAtt.hasCheckedOut(value, parsedDate, Time.valueOf(timeString)); // Converted to Time data type
        if (alreadyCheckedIn) {
            JOptionPane.showMessageDialog(null, "You are already logged out for today.");
